                                ...
                                <tr>
                                    ...
                                    <td class="val">
                                        ...
                                        @if($invoice->lease?->unit?->facility)
                                            <br><span
                                                style="font-size:11px; color:#64748b; font-weight:400;">{{ $invoice->lease->unit->facility->name }}</span>
                                        @endif
                                    </td>
                                </tr>
                            </table>
                ...
                @if($stampData || $signatureData)
                    <div style="text-align: right; margin-top: 30px; padding-right: 20px;">
                        <div style="display: inline-block; text-align: center;">
                            ...
                            <div
                                style="border-top: 1px solid #cbd5e1; padding-top: 5px; font-weight: bold; font-size: 10px; color: #64748b; text-transform: uppercase; letter-spacing: 1px;">
