...
.inv-number { font-size: 18px; font-weight: 700; color: #1e293b; }
...
/* ── Period box ── */
.period-box { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 6px; padding: 12px 16px; margin-bottom: 24px; }
    ...
    <table class="header-table" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td class="meta-right" style="vertical-align:top;">
                <div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px;color:#94a3b8;">Invoice</div>
    ...
    <table class="parties-table" cellpadding="0" cellspacing="0">
        <tr>
            ...
            <td style="vertical-align:top; text-align:right;">
                ...
                @if ($invoice->lease?->unit?->size_label)<div class="party-detail">{{ $invoice->lease->unit->size_label }}</div>@endif
            </td>
        </tr>
    </table>
