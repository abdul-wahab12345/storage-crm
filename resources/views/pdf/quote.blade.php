    ...
    <div class="page" style="padding:0 0 36px 0;">
        ...
        <div style="padding: 0 40px;">
            ...
            <table class="parties-table" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="vertical-align:top; width:55%;">
                        ...
                        <div class="party-detail">{{ $quote->client_email }}</div>@endif
                        @if ($quote->client_phone)
                        <div class="party-detail">{{ $quote->client_phone }}</div>@endif
                    </td>
            ...
            @if ($quote->scope_of_work)
                <div class="tc-box" style="margin-top:20px;">
                    <div class="tc-title">Scope of Work</div>
                    <div class="tc-body">{!! $quote->scope_of_work !!}</div>
                </div>
            @endif
            ...
            <div class="footer" style="margin-top: 28px;">
                <p>This quote is valid until
                    {{ $quote->valid_until ? $quote->valid_until->format('F j, Y') : 'further notice' }}.
                </p>
